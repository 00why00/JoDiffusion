...
accelerate launch --mixed_precision="fp16" --multi_gpu --num_processes 4 train_ldm.py \
  --pretrained_model_name_or_path=$MODEL_NAME --dataset_name="ade20k_semantic" --caption_column="blip2" \
  ...
  --output_dir="output/jodiffusion-vae-light-ade20k-semantic-blip2-joint-5e5"
